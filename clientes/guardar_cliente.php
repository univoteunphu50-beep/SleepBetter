...
$verificar = $conn->prepare("SELECT cedula FROM clientes WHERE cedula = ?");
...
// Insertar datos
$stmt = $conn->prepare("INSERT INTO clientes (cedula, cliente, telefono, email, direccion, comentarios) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("ssssss", $cedula, $cliente, $telefono, $email, $direccion, $comentarios);
